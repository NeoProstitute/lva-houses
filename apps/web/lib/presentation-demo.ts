...
const houses = [
  ...
  { id: "humanitas", name: "Humanitas", color: "#AA2626", iconUrl: "/house-emblems/humanitas-mark-v2.png", meaning: "Empathy", symbol: "Hand", description: "Empathy brings people together through care, understanding and shared humanity.", totalPoints: 68, studentCount: 1 },
...
export function presentationResponse(path: string): unknown {
  ...
  if (path === "/api/v1/houses/leaderboard") return { houses, studentLeaders: [{ name: "Liliana Netland", houseName: "Curiositas", houseColor: "#FFDA61", totalPoints: 75 }, { name: "Doria the exploria", houseName: "Humanitas", houseColor: "#AA2626", totalPoints: 68 }, { name: "Kanye Wesley", houseName: "Veritas", houseColor: "#4677E6", totalPoints: 62 }, { name: "Oliver Tree", houseName: "Sapientia", houseColor: "#602889", totalPoints: 58 }] };
