...
const previewLeaderboard: Leaderboard = {
  ...
  houses: [
    ...
    { id: "00000000-0000-4000-8000-000000000002", name: "Humanitas", color: "#AA2626", iconUrl: "/house-emblems/humanitas-mark-v3.png", meaning: "Empathy", symbol: "Hand", description: "Empathy brings people together through care, understanding and shared humanity.", totalPoints: 68, studentCount: 1 },
  ...
  studentLeaders: [
    ...
    { name: "Doria the exploria", houseName: "Humanitas", houseColor: "#AA2626", totalPoints: 68 },
  ...
  houseLeaders: [
    ...
    { houseId: "00000000-0000-4000-8000-000000000002", name: "Doria the exploria", houseName: "Humanitas", houseColor: "#AA2626", totalPoints: 68 },
